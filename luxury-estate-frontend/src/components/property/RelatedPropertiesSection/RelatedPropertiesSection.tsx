...
export function RelatedPropertiesSection({
  ...
  const {
    ...
    queryFn: () =>
      getRelatedProperties(propertyId),
  })
  ...
  return (
    <section className="relative overflow-hidden bg-slate-50 py-24">
      ...
      <div className="absolute inset-0 opacity-40">
        <div className="absolute -left-32 top-0 h-96 w-96 rounded-full bg-[#C6A15B]/10 blur-3xl" />

        <div className="absolute bottom-0 right-0 h-72 w-72 rounded-full bg-slate-200 blur-3xl" />
      </div>
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Discover additional premium properties that match your lifestyle and investment preferences.
            </p>
          </div>
